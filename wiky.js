...
{
var defaultreturn = "Main";
var getdatastring = self.location.href.split("#")[0].split("?");
if(getdatastring[1] == undefined){return defaultreturn;}
var getdatastring = getdatastring[1];
var getarglist = getdatastring.split("&");
        for (var i = 0; i < getarglist.length; i++)
        {
        var argument = getarglist[i];
        var nameAndData = argument.split("=");

                if (argname == nameAndData[0])
                {
